...
# s.tvos.deployment_target = "9.0"
    ...
    s.source       = { :git => "https://github.com/ByteriX/BxUpdateManager.git", :tag => s.version }
    s.frameworks = ["Foundation"]
    #s.resources = "BxTextField/Sources/Assets.xcassets", "BxUpdateManager/Sources/**/*.xib"

    s.source_files  = "BxUpdateManager/Sources/**/*.{swift}", "BxUpdateManager/Sources/*.{swift}"
